...
new ffjavascript.ZqField(SNARK_FIELD_SIZE);
/**
...
function genRandomNumber(numberOfBytes) {
    ...
    return bigintConversion.bufToBigint(random.randomBytes(numberOfBytes));
}
    ...
    function ZkIdentity(strategy, metadata) {
        ...
        switch (strategy) {
            ...
            case exports.Strategy.MESSAGE: {
                ...
                this._identityTrapdoor = bigintConversion.hexToBigint(sha256("".concat(messageHash, "identity_trapdoor")));
                this._identityNullifier = bigintConversion.hexToBigint(sha256("".concat(messageHash, "identity_nullifier")));
                this._secret = [this._identityNullifier, this._identityTrapdoor];
                break;
            }
            case exports.Strategy.SERIALIZED: {
                ...
                this._identityNullifier = bigintConversion.hexToBigint(identityNullifier);
                this._identityTrapdoor = bigintConversion.hexToBigint(identityTrapdoor);
                this._secret = secret.map(function (item) { return bigintConversion.hexToBigint(item); });
                break;
            }
            default:
