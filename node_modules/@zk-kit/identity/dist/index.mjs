...
import { bufToBigint, hexToBigint } from 'bigint-conversion';
    ...
    function ZkIdentity(strategy, metadata) {
        ...
        switch (strategy) {
            ...
            case Strategy.MESSAGE: {
                ...
                this._identityTrapdoor = hexToBigint(sha256("".concat(messageHash, "identity_trapdoor")));
                this._identityNullifier = hexToBigint(sha256("".concat(messageHash, "identity_nullifier")));
                this._secret = [this._identityNullifier, this._identityTrapdoor];
                break;
            }
            case Strategy.SERIALIZED: {
                ...
                this._secret = secret.map(function (item) { return hexToBigint(item); });
                break;
            }
            default:
